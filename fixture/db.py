    ...
    def get_group_list_from_db(self):
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                header = row[2]
                footer = row[3]
                group_list_from_db.append(Group(id=str(id), name=name, header=header, footer=footer))
        finally:
            cursor.close()
    ...
    def get_contact_list_from_db(self):
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                contact_list_from_db.append(Contact(id=str(id), firstname=firstname, lastname=lastname, address=address, email=email))
        finally:
            cursor.close()
